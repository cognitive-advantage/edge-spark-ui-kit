...
docs/developers/index.md should be referenced during code reviews to ensure adherence to these standards. Reviewers must verify that new code follows the established architecture, principles, and coding standards outlined here.
